...
docker --storage-driver=devicemapper run -i -t -d -P  --privileged=true --name launcher -v /home/$USER/ssh_for_docker:/opt/from_host/ssh:ro -v /home/$USER/.aws/:/opt/from_host/aws:ro   seqware/launcher /bin/bash
